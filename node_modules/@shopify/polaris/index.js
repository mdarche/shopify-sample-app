  ...
  return Object.assign.apply(Object, [{}].concat(_toConsumableArray(Object.entries(colors).map(function (_ref) {
    ...
    return Object.assign({}, variants.reduce(function (accumulator, _a) {
      ...
      return Object.assign(Object.assign({}, accumulator), {
        [name]: hslToString(Object.assign(Object.assign({}, colorToHsla(hsluv.hsluvToHex([hue, saturation, lightness]))), {
          alpha
        }))
      });
    }, {}));
  ...
  _createClass(Focus, [{
    ...
    value: function componentDidUpdate(_a) {
      var prevChildren = _a.children,
          restPrevProps = tslib.__rest(_a, ["children"]);

      var _b = this.props,
          children = _b.children,
          restProps = tslib.__rest(_b, ["children"]);
  ...
  function TrapFocus() {
    ...
    _this.handleBlur = function (event) {
      ...
      if (focusTrapWrapper && !focusTrapWrapper.contains(relatedTarget) && (!relatedTarget || !dom.closest(relatedTarget, '[data-polaris-overlay]'))) {
        ...
        var firstNode = focus.findFirstFocusableNode(focusTrapWrapper) || focusTrapWrapper;
        fastdom.write(function () {
